 ...
 * @author alexe
 */
public class EnemigosMundo2 extends GeneradorDeEnemigos{
    
     public EnemigosMundo2(World world, Texture textureEnemigo1, Texture textureEnemigo2) {
        super(world, textureEnemigo1, textureEnemigo2);
        
            generarEnemigos(1,0,1);
            generarEnemigos(2,8,0);
            generarEnemigos(1,1,0);
            generarEnemigos(2,14,0);
            generarEnemigos(1,1,1);
            generarEnemigos(1,14,1);
